...
export class TextObjectWord extends TextObject {
  ...
  static byWord(args: { useBlankSeparatedStyle: boolean; isInclusive: boolean }): TextObjectWord {
  ...
  findEndRange(document: TextDocument, anchor: Position): Range {
    ...
    return new Range(lineIndex, exclusiveCharacterIndex + 1, lineIndex, inclusiveCharacterIndex + 1)
  }
